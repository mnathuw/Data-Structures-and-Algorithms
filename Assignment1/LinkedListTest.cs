...
namespace TestLibrary
{
    ...
    public class LinkedListTest
    {
        ...
        private bool CheckIntegrityBetweenListOfOneNode(Node<Employee> head, Node<Employee> first, Node<Employee> tail, Func<int> size)
        {
        ...
        public void AddAfterByElement_multiple_match_found_adds_after_first_instance_Test()
        {
            ...
            list.AddFirst(employee);
            // 1
            Node<Employee> fourth = list.Head; // 1

            // 2 1
            list.AddFirst(employee2);
            Node<Employee> third = list.Head; // 2

            // 1 2 1
            list.AddFirst(employee); // order will be: 1, 2, 1
            Node<Employee> first = list.Head; // 1
